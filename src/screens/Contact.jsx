            ...
            <div className={`flex portrait:flex-col h-full justify-evenly items-center overflow-y-auto font-montserrat ${darkMode ? "bg-zinc-800 text-white" : "bg-zinc-300"}`}>
                <div className="space-y-5 text-center">
                    ...
                    <div className="flex items-center justify-center gap-10 scale-75">
                        ...
                        <a className="transition hover:scale-105 duration:300 ease-in-out" href="https://github.com/pi-person314"><img className={`${darkMode ? "invert hue-rotate-180" : ""}`} src={github} alt="GitHub"/></a>
                    </div>
                </div>
