...
export default function Home({darkMode}) {
    return (
        <div className={`flex portrait:flex-col justify-evenly items-center h-full overflow-y-auto bg-gradient-to-b ${darkMode ? "from-zinc-800 via-zinc-700 to-zinc-800 text-white" : "from-zinc-400 via-zinc-300 to-zinc-400"}`}>
            <div className="m-10">
