    ...
    return (
        <div className={`flex flex-col lg:flex-row justify-evenly items-center h-full bg-gradient-to-b ${darkMode ? "from-green-900 via-green-800 to-green-900 text-white" : "from-green-400 via-green-300 to-green-400"}`}>
            <div className="m-5 md:m-10">
                ...
                <p className="text-lg md:text-xl text-center">Check out some of my <Link className={`hover:text-blue-${darkMode ? 300 : 600}`} to="/about"><u>interests</u></Link> and <Link className={`hover:text-blue-${darkMode ? 300 : 600}`} to="/projects"><u>projects</u></Link>, and feel free to <Link className={`hover:text-blue-${darkMode ? 300 : 600}`} to="/contact"><u>reach out</u></Link>!</p>
            </div>
