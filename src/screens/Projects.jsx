...
export default function Projects() {
    return (
        <>
            ...
            <div className="grid grid-cols-2 auto-rows-[50rem] bg-green-300 overflow-y-auto h-full">
                <div className="flex flex-col justify-evenly bg-green-400 shadow-xl rounded-xl p-10 m-10">
