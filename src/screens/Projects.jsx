    ...
    return (
        <>
            ...
            <div className={`tiny:flex tiny:flex-col grid grid-cols-2 lg:auto-rows-[50rem] overflow-y-auto h-full font-montserrat ${darkMode ? "bg-zinc-800 text-white" : "bg-zinc-300"}`}>
                ...
                <div className={`flex flex-col space-y-5 justify-evenly shadow-xl rounded-xl p-10 m-10 ${darkMode ? "bg-zinc-700" : "bg-zinc-400"}`}>
                    <img className="tiny:h-2/3 h-1/2 justify-self-center object-contain" src={placeholder}/>
                    <h1 className="text-xl lg:text-4xl text-center font-serif"><b>Summer Project #1</b></h1>
                    <p className="text-sm lg:text-lg">TBD</p>
                </div>
                <div className={`flex flex-col space-y-5 justify-evenly shadow-xl rounded-xl p-10 m-10 ${darkMode ? "bg-zinc-700" : "bg-zinc-400"}`}>
                    <img className="tiny:h-2/3 h-1/2 justify-self-center object-contain" src={placeholder}/>
                    <h1 className="text-xl lg:text-4xl text-center font-serif"><b>Summer Project #2</b></h1>
                    <p className="text-sm lg:text-lg">TBD</p>
                </div>
            </div>
        </>
