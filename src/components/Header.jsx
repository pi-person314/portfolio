...
export default function Header({toggleDarkMode}) {
    return (
        <header className="flex justify-between space-x-5 bg-green-700 text-white p-5">
            ...
            <div className="flex justify-center items-center mx-auto space-x-10">
                <Link className="short:text-sm narrow:text-sm text-xl font-serif hover:text-blue-300" to="/about">About</Link>
                <Link className="short:text-sm narrow:text-sm text-xl font-serif hover:text-blue-300" to="/projects">Projects</Link>
                <Link className="short:text-sm narrow:text-sm text-xl font-serif hover:text-blue-300" to="/contact">Contact</Link>
            </div>
            <div className="flex items-center">
